...
public class InternQ3 extends JFrame implements ActionListener 
{
    ...
    public InternQ3() {
        windowSize();
        //declaration
        Q3 = new JLabel ("Do you think you have potential to be our permanent employee?");
